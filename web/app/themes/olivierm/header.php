...
<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
	...
	<header role="banner" itemscope itemtype="http://schema.org/WPHeader">
		<div class="header-inner cbo-container container--nomargin">
			<a class="header-logo cbo-picture-contain" title="Accueil - <?php echo get_bloginfo('description'); ?>" href="<?php echo home_url(); ?>" itemprop="url">
				<img
					decoding="async"
					src="<?php bloginfo('template_directory'); ?>/library/img/logo-olivier-massot.png"
			...
			<div class="header-right">
				...
				<div class="cbo-languages">
					<ul class="languages-switcher" itemscope itemtype="http://schema.org/Language">
						<?php
							$languages = pll_the_languages( array('show_flags' => 1, 'show_names' => 0, 'echo' => 0) );
							echo $languages;
						?>
					</ul>
				</div>
